      ...
      items: [
        {
          ...
          tooltip: "Your ingredient database with costs & allergens",
        },
        {
          icon: CircleDollarSign,
          label: "Vendor Invoices",
          path: "/admin/data/invoices",
          tooltip: "Import & track vendor pricing",
        },
        {
          icon: Package,
          label: "Food Inventory",
          path: "/admin/data/inventory",
          tooltip: "Count, review & approve inventory sessions",
        },
      ],
    },
    {
